...
public enum HDError {
	...
	ERROR_DESTROYED(15, "Activity or Fragment is destroyed !"),
	ERROR_DB(16, "数据库操作异常"),
	//======================= 自定义错误 ↑ ==============================//
	...
	public static HDError valueOf(int code) {
		for (HDError error : HDError.values()) {
