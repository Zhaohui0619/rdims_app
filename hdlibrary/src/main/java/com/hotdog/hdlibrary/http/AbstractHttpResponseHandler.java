...
public abstract class AbstractHttpResponseHandler<Result> implements Callback, Handler.Callback, IParser<Result> {
    ...
    @WorkerThread
    public abstract Result parse(HDHttpResponse body) throws IOException;
     ...
     */
    @MainThread
    public void onStart(HDHttpRequest request) {
     ...
     */
    @MainThread
    public void onCancel(HDHttpRequest request){
     ...
     */
    @MainThread
    public void onProgress(HDHttpRequest request, @Nullable Map<String, String> headers, int progress) {
     ...
     */
    @MainThread
    public void onSuccess(HDHttpRequest request, @Nullable Map<String, String> headers, Result result) {
     ...
     */
    @MainThread
    public void onFailure(HDHttpRequest request, @Nullable Map<String, String> headers, Exception e) {
        e.printStackTrace();
     ...
     */
    @MainThread
    public void onFinish(HDHttpRequest request) {
     ...
     */
    @MainThread
    public void onFinally(HDHttpRequest request) {
    ...
    public final void onResponse(Call call, Response response) throws IOException {
        ...
        if (response.isSuccessful()) {
            try {
                this.fireOnSuccess(parse(HDHttpResponse.create(response)));
            } catch (Exception e) {
     ...
     */
    void setRequest(HDHttpRequest mRequest) {
