...
public class HDHttpRequestParams implements Cloneable {
    ...
    public HDHttpRequestParams() {
        this(APPLICATION_FORM);
    }

    public HDHttpRequestParams(@ContentType String contentType) {
        this.contentType = contentType;
    }

    public HDHttpRequestParams put(RequestBody body) {
        this.postBody = body;
        return this;
    }

    public HDHttpRequestParams put(JSONObject param) {
    ...
    public HDHttpRequestParams put(HDHttpRequestParams params) {
        if (params != null) {
    ...
    public HDHttpRequestParams put(Map<String, Object> params) {
    ...
    public HDHttpRequestParams put(String key, Object value) {
    ...
    public HDHttpRequestParams put(String key, InputStream stream) {
        return put(key, stream, null);
    }

    public HDHttpRequestParams put(String key, InputStream stream, String name) {
        return put(key, stream, name, null);
    }

    public HDHttpRequestParams put(String key, InputStream stream, String name, String contentType) {
    ...
    public HDHttpRequestParams put(String key, File file) {
        return put(key, file, null);
    }

    public HDHttpRequestParams put(String key, File file, String contentType) {
...
//        }
    ...
    public String toString() {
        ...
        if (!objectParams.isEmpty()) {
            builder.append(new JSONObject(objectParams).toString());
        }
